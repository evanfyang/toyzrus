...
CREATE TABLE Products (productID INT PRIMARY KEY NOT NULL AUTO_INCREMENT, name VARCHAR(40) NOT NULL, price DECIMAL(10,2) NOT NULL, inventory INT NOT NULL, category VARCHAR(30) NOT NULL, promotions INT NOT NULL);
